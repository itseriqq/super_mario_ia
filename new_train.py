...
def eval_genomes(genomes, config):
    ...
    for genome_id, genome in genomes:
        ...
        while not done:
            ...
            if end == 1:
                fitness_current += 200000
                done = True
                time_end = time.time() - time_ini
                print("Tempo da run: ", str(time_end))
                fitness_current -= (time_end * 20)  # Penalizando o tempo
            ...
            if done or counter == 250:
                ...
                fitness_current -= float(time_end)*20  # Penalizando o tempo
                time_ini = time.time()  # Resetando o tempo
